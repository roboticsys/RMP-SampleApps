/*! 
 *  @example    UserLimitPositionOneCondition.cs 
 
 *  @page       one-condition-position-user-limit-cs UserLimitPositionOneCondition.cs
 ...
 *  @include UserLimitPositionOneCondition.cs 
 */
