/*! 
*  @example    MotionHoldReleasedByDigitalInput.cpp

*  @page       motion-hold-released-by-digital-input-cpp MotionHoldReleasedByDigitalInput.cpp
...
*
* @include MotionHoldReleasedByDigitalInput.cpp
